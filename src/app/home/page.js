...
// 1. استدعاء السايد بار من الملف التاني (تأكد من مسار الملف بتاعك)
    ...
    <div className="min-h-screen bg-[#0A0F1A] font-sans antialiased text-white">
      ...
      <header className="w-full h-[72px] flex items-center justify-between px-6 lg:px-8 bg-[#0A0F1A] border-b border-white/5 sticky top-0 z-30" dir="ltr">
        ...
        <div className="flex items-center gap-5">
          ...
          >
            <div className={`w-[22px] h-[22px] bg-white rounded-full flex items-center justify-center absolute transition-all duration-300 ${isDarkMode ? "right-[2px]" : "left-[2px]"}`}>
              {isDarkMode ? <MoonIcon className="w-3.5 h-3.5 text-[#0A0F1A]" /> : <SunIcon className="w-3.5 h-3.5 text-amber-500" />}
            </div>
          </button>
        ...
        <div className="flex items-center gap-6">
          ...
          {/* 🎯 زر القائمة (الهامبرجر) اللي بيفتح السايد بار */}
          <button 
      ...
      {/* ========================================= */}
      {/* 🌑 استدعاء السايد بار من الملف التاني */}
      {/* ========================================= */}
      {/* بنبعتله الـ State عشان يعرف هو مفتوح ولا مقفول، وبنبعتله دالة القفل */}
...
// 🎨 SVG Icons 
// ==========================================
const MoonIcon = ({ className }) => <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.718 9.718 0 0118 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 003 11.25C3 16.635 7.365 21 12.75 21a9.753 9.753 0 009.002-5.998z" /></svg>;
const SunIcon = ({ className }) => <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z" /></svg>;
const SearchIcon = ({ className }) => <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth="2.5" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M21 21l-5.197-5.197m0 0A7.5 7.5 0 105.196 5.196a7.5 7.5 0 0010.607 10.607z" /></svg>;
const WalletIcon = ({ className }) => <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M21 12a2.25 2.25 0 00-2.25-2.25H15a3 3 0 110-6h3.75A2.25 2.25 0 0121 6v6zM21 15v-3m0 3a2.25 2.25 0 01-2.25 2.25H5.25A2.25 2.25 0 013 15V9a2.25 2.25 0 012.25-2.25H15a3 3 0 110 6h3.75A2.25 2.25 0 0121 15z" /></svg>;
const BellIcon = ({ className }) => <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M14.857 17.082a23.848 23.848 0 005.454-1.31A8.967 8.967 0 0118 9.75v-.75a6 6 0 00-6-6v-.75a8.967 8.967 0 01-2.312 6.022c1.733.64 3.56 1.085 5.455 1.31m5.714 0a24.255 24.255 0 01-5.714 0m5.714 0a3 3 0 11-5.714 0" /></svg>;
const UserIcon = ({ className }) => <svg className={className} viewBox="0 0 24 24" fill="currentColor"><path fillRule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clipRule="evenodd" /></svg>;
const MenuIcon = ({ className }) => <svg className={className} fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" /></svg>;
